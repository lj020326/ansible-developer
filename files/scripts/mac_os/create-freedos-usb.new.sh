...
#FREEDOS_IMAGE_PATH="${HOME}/Downloads/software/boot-utils/FD14-LiveCD/FD14LIVE.iso"
...
function create_freedos_usb() {
  ...
  #  COMMAND_ARRAY+=("dd if=${FREEDOS_IMAGE_PATH} of=${FREEDOS_DISK_PATH} bs=4M status=progress")
    ...
    ## ref: https://www.youtube.com/watch?v=--rjODQZCzk&t=201
    COMMAND_ARRAY+=("hdiutil mount -mountpoint ${TEMP_DIR} ${FREEDOS_IMAGE_PATH}")

    ## ref: https://apple.stackexchange.com/questions/338718/creating-bootable-freedos-dos-floppy-diskette-img-file-for-v86-on-osx
    COMMAND_ARRAY+=("cp ${TEMP_DIR}/COMMAND.COM ${FREEDOS_IMAGE_PATH}")
...
function main() {
  ...
  checkRequiredCommands diskutil
