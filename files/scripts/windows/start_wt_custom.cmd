...
set tab2_profile="ssh-control01"
set tab2_title="control01"

set tab3_profile="ssh-nas02"
set tab3_title="nas02"
...
wt new-tab -p %tab1_profile% --title %tab1_title% --suppressApplicationTitle ; ^
  ...
  new-tab -p %tab3_profile% --title %tab3_title% --suppressApplicationTitle ; ^
